  ...
  <style>
    * {
    ...
    .pay-page {
      ...
      gap: 14px;
      background: linear-gradient(145deg, #f6f8fc 0%, #edf2f7 55%, #eaf0f8 100%);
      min-height: 100vh
    }
    ...
    .field input:focus {
      border-color: #F7DF79;
      box-shadow: 0 0 0 3px rgba(247, 223, 121, .18)
    }
    ...
    .checkout-btn {
      ...
      cursor: pointer;
      margin-top: 10px;
      box-shadow: 0 4px 14px rgba(247, 223, 121, .35)
    }
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div style="margin-top:10px">
            <div style="font-size:10px;font-weight:900;color:#94a3b8;text-transform:uppercase;letter-spacing:.08em">
              Payment Method</div>
            <div class="methods">
              <button class="m-btn active" data-method="cash" onclick="setPayment('cash')"><i
                  data-lucide="banknote"></i><span>Cash</span></button>
              <button class="m-btn" data-method="card" onclick="setPayment('card')"><i
                  data-lucide="credit-card"></i><span>Card</span></button>
              <!-- <button class="m-btn" data-method="bank" onclick="setPayment('bank')"><i data-lucide="landmark"></i><span>Bank</span></button> -->
              <button class="m-btn" data-method="split" onclick="setPayment('split')"><i
                  data-lucide="arrow-left-right"></i><span>Split</span></button>
            </div>
          </div>
          ...
          <div id="split-panel" class="panel" style="display:none">
            <div class="panel-row"><label style="font-size:12px;font-weight:700;color:#475569">Cash</label><input
                id="split-cash" type="number" placeholder="0.00" oninput="updateSplitRemaining()"></div>
